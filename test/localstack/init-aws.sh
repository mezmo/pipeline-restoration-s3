...
echo "log line - Thu Dec 25 1997 07:23:36 GMT+0000" | awslocal s3 cp - s3://test-bucket/myprefix_883034616.log
echo "log line - Wed Jan 10 2024 10:14:41 GMT+0000" | awslocal s3 cp - s3://test-bucket/myprefix_1704881681.log
echo "log line - Wed Jan 10 2024 14:14:41 GMT+0000" | awslocal s3 cp - s3://test-bucket/myprefix_1704896081.log
echo "log line - Thu Dec 25 1997 07:23:36 GMT+0000" | awslocal s3 cp - s3://test-bucket/f/myprefix_883034616.log
echo "log line - Wed Jan 10 2024 10:14:41 GMT+0000" | awslocal s3 cp - s3://test-bucket/f/myprefix_1704881681.log
echo "log line - Wed Jan 10 2024 14:14:41 GMT+0000" | awslocal s3 cp - s3://test-bucket/f/myprefix_1704896081.log
